class Admin::VideosController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_video.save
        format.html { redirect_to @admin_video, notice: 'Video criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @admin_video.update(admin_video_params)
        format.html { redirect_to @admin_video, notice: 'Video atualizado com sucesso.' }
  ...
  def destroy
    @admin_video.destroy
    respond_to do |format|
      format.html { redirect_to admin_videos_url, notice: 'Video deletado com sucesso.' }
  ...
  private
    ...
    def admin_video_params
      params.require(:admin_video).permit(:descricao)
    end
end
